...
// uerdefaultls的key
#define KMemberIdKey        @"loginMemberId"
#define KMemberId  [[NSUserDefaults standardUserDefaults] objectForKey:@"loginMemberId"]

#define KMemberTokenKey     @"token"
#define KMemberToken [[NSUserDefaults standardUserDefaults] objectForKey:KMemberTokenKey]

#define KMemberName  [[NSUserDefaults standardUserDefaults] objectForKey:@"membername"]
#define KLoginName   [[NSUserDefaults standardUserDefaults] objectForKey:@"loginUserName"]
#define KLoginNameKey       @"loginUserName"
#define KMemberNameKey        @"membername"
...
#define kDongaccesstoken @"KToken"
